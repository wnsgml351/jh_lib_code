...
for i, thum_img in enumerate(thum_imgs):
    ...
    # 클릭이벤트를 실행하게되면 intercept 에러가 발생함
    # 자바스크립트 클릭함수 만들기
    browser.execute_script("arguments[0].click();", thum_img)
    ...
    # 큰 이미지 주소 추출
    if i == 1:
        target = browser.find_elements(By.CSS_SELECTOR, "img.r48jcc")[0]
    else:
        target = browser.find_elements(By.CSS_SELECTOR, "img.r48jcc")[1]
